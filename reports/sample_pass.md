...
|---|---|---|---|---|---|
| http://localhost:8123 | release_questions.yaml (sha256 ebe4f05c6625) | qwen3.6:27b (local) | 2026-08-05 18:34 UTC | 291.76s | agent-report-card 0.1.0 |
...
| latency p50 / p95 | 0.00s / 0.01s | over 12 requests |
